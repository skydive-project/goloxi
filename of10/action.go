...
func decodeAction(decoder *goloxi.Decoder) (IAction, error) {
	...
	case 3:
		return decodeActionStripVlan(action, decoder)
	case 4:
	...
	case 11:
		return decodeActionEnqueue(action, decoder)
	case 65535:
...
func decodeActionEnqueue(parent *Action, decoder *goloxi.Decoder) (*ActionEnqueue, error) {
	actionenqueue := &ActionEnqueue{Action: parent}
	if decoder.Length() < 12 {
		return nil, fmt.Errorf("ActionEnqueue packet too short: %d < 12", decoder.Length())
	}
	actionenqueue.Port.Decode(decoder)
	decoder.Skip(6)
	actionenqueue.QueueId = uint32(decoder.ReadUint32())
...
func decodeActionStripVlan(parent *Action, decoder *goloxi.Decoder) (*ActionStripVlan, error) {
	actionstripvlan := &ActionStripVlan{Action: parent}
	if decoder.Length() < 8 {
