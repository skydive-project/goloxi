...
func DecodeBundleFeaturesPropTime(parent *BundleFeaturesProp, decoder *goloxi.Decoder) (*BundleFeaturesPropTime, error) {
	...
	decoder.Skip(4)
	_bundlefeaturesproptime.SchedAccuracy.Decode(decoder)
	_bundlefeaturesproptime.SchedMaxFuture.Decode(decoder)
	_bundlefeaturesproptime.SchedMaxPast.Decode(decoder)
	_bundlefeaturesproptime.Timestamp.Decode(decoder)
...
func DecodeGroupPropExperimenter(decoder *goloxi.Decoder) (IGroupPropExperimenter, error) {
	...
	// if _grouppropexperimenter.Type != 65535 {
	// 	return fmt.Errorf("Wrong value '%d' for type, expected '65535'.", _grouppropexperimenter.Type)
	// }
...
func DecodePortDescPropEgress(decoder *goloxi.Decoder) (*PortDescPropEgress, error) {
	...
	// if _portdescpropegress.Type != 3 {
	// 	return fmt.Errorf("Wrong value '%d' for type, expected '3'.", _portdescpropegress.Type)
	// }
	_portdescpropegress.Length = uint16(decoder.ReadUint16())
	decoder = decoder.SliceDecoder(int(_portdescpropegress.Length), 2+2)
	_portdescpropegress.OxmIds = decoder.Read(decoder.Length())
...
func DecodePortDescPropIngress(decoder *goloxi.Decoder) (*PortDescPropIngress, error) {
	...
	// if _portdescpropingress.Type != 2 {
	// 	return fmt.Errorf("Wrong value '%d' for type, expected '2'.", _portdescpropingress.Type)
	// }
	_portdescpropingress.Length = uint16(decoder.ReadUint16())
	decoder = decoder.SliceDecoder(int(_portdescpropingress.Length), 2+2)
	_portdescpropingress.OxmIds = decoder.Read(decoder.Length())
...
func DecodeQueueStatsPropBsn(parent *QueueStatsPropExperimenter, decoder *goloxi.Decoder) (*QueueStatsPropBsn, error) {
	...
	_queuestatspropbsn.ExperimenterData = decoder.Read(decoder.Length())
...
func DecodeRolePropBsn(parent *RolePropExperimenter, decoder *goloxi.Decoder) (*RolePropBsn, error) {
	...
	_rolepropbsn.ExperimenterData = decoder.Read(decoder.Length())
...
func DecodeTableFeaturePropOxmValues(decoder *goloxi.Decoder) (*TableFeaturePropOxmValues, error) {
	...
	// if _tablefeaturepropoxmvalues.Type != 22 {
	// 	return fmt.Errorf("Wrong value '%d' for type, expected '22'.", _tablefeaturepropoxmvalues.Type)
	// }
	...
	_tablefeaturepropoxmvalues.OxmValues = decoder.Read(decoder.Length())
...
func DecodeActionCopyField(decoder *goloxi.Decoder) (*ActionCopyField, error) {
	...
	// if _actioncopyfield.Type != 28 {
	// 	return fmt.Errorf("Wrong value '%d' for type, expected '28'.", _actioncopyfield.Type)
	// }
...
func DecodePortDescPropRecirculate(decoder *goloxi.Decoder) (*PortDescPropRecirculate, error) {
	...
	// if _portdescproprecirculate.Type != 4 {
	// 	return fmt.Errorf("Wrong value '%d' for type, expected '4'.", _portdescproprecirculate.Type)
	// }
	...
	_portdescproprecirculate.PortNos = decoder.Read(decoder.Length())
