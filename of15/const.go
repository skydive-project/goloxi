...
const (
	...
	OFPBFCSchedNotSupported = 16 // OFPBFC_SCHED_NOT_SUPPORTED
	OFPBFCSchedFuture       = 17 // OFPBFC_SCHED_FUTURE
	OFPBFCSchedPast         = 18 // OFPBFC_SCHED_PAST
)
...
const (
	// Identifiers from group ofp_bundle_feature_flags
	OFPBFTimestamp    = 1 // OFPBF_TIMESTAMP
	OFPBFTimeSetSched = 2 // OFPBF_TIME_SET_SCHED
)

type BundleFeatureFlags uint32
...
const (
	// Identifiers from group ofp_bundle_features_prop_type
	OFPTMPBFTimeCapability = 1     // OFPTMPBF_TIME_CAPABILITY
	OFPTMPBFExperimenter   = 65535 // OFPTMPBF_EXPERIMENTER
)
...
const (
	// Identifiers from group ofp_bundle_prop_type
	OFPBPTTime         = 1     // OFPBPT_TIME
	OFPBPTExperimenter = 65535 // OFPBPT_EXPERIMENTER
)
...
const (
	...
	OFPCBundles        = 512  // OFPC_BUNDLES
	OFPCFlowMonitoring = 1024 // OFPC_FLOW_MONITORING
)
...
const (
	// Identifiers from group ofp_control_channel_status
	OFPCTStatusUp   = 0 // OFPCT_STATUS_UP
	OFPCTStatusDown = 1 // OFPCT_STATUS_DOWN
)
...
const (
	// Identifiers from group ofp_controller_status_prop_type
	OFPCSPTUri          = 0     // OFPCSPT_URI
	OFPCSPTExperimenter = 65535 // OFPCSPT_EXPERIMENTER
)

const (
	// Identifiers from group ofp_controller_status_reason
	OFPCSRRequest           = 0 // OFPCSR_REQUEST
	OFPCSRChannelStatus     = 1 // OFPCSR_CHANNEL_STATUS
	OFPCSRRole              = 2 // OFPCSR_ROLE
	OFPCSRControllerAdded   = 3 // OFPCSR_CONTROLLER_ADDED
	OFPCSRControllerRemoved = 4 // OFPCSR_CONTROLLER_REMOVED
	OFPCSRShortID           = 5 // OFPCSR_SHORT_ID
	OFPCSRExperimenter      = 6 // OFPCSR_EXPERIMENTER
)
...
const (
	...
	OFPFMFCIsSync      = 10 // OFPFMFC_IS_SYNC
)
...
const (
	// Identifiers from group ofp_flow_stats_reason
	OFPFSRStatsRequest = 0 // OFPFSR_STATS_REQUEST
	OFPFSRStatTrigger  = 1 // OFPFSR_STAT_TRIGGER
)
...
const (
	// Identifiers from group ofp_group_bucket
	OFPGBucketMax   = 4294967040 // OFPG_BUCKET_MAX
	OFPGBucketFirst = 4294967293 // OFPG_BUCKET_FIRST
	OFPGBucketLast  = 4294967294 // OFPG_BUCKET_LAST
	OFPGBucketAll   = 4294967295 // OFPG_BUCKET_ALL
)
...
const (
	// Identifiers from group ofp_group_bucket_prop_type
	OFPGBPTWeight       = 0     // OFPGBPT_WEIGHT
	OFPGBPTWatchPort    = 1     // OFPGBPT_WATCH_PORT
	OFPGBPTWatchGroup   = 2     // OFPGBPT_WATCH_GROUP
	OFPGBPTExperimenter = 65535 // OFPGBPT_EXPERIMENTER
)
...
const (
	...
	OFPGCInsertBucket = 3 // OFPGC_INSERT_BUCKET
	OFPGCRemoveBucket = 5 // OFPGC_REMOVE_BUCKET
)
...
const (
	...
	OFPGMFCUnknownBucket       = 15 // OFPGMFC_UNKNOWN_BUCKET
	OFPGMFCBucketExists        = 16 // OFPGMFC_BUCKET_EXISTS
)
...
const (
	// Identifiers from group ofp_group_prop_type
	OFPGPTExperimenter = 65535 // OFPGPT_EXPERIMENTER
)
...
const (
	// Identifiers from group ofp_header_type_namespace
...
const (
	// Identifiers from group ofp_header_type_onf
	OFPHTOEthernet        = 0     // OFPHTO_ETHERNET
	OFPHTONoHeader        = 1     // OFPHTO_NO_HEADER
	OFPHTOOXMExperimenter = 65535 // OFPHTO_OXM_EXPERIMENTER
)
...
const (
	...
	OFPITDeprecated    = 6     // OFPIT_DEPRECATED
	OFPITStatTrigger   = 7     // OFPIT_STAT_TRIGGER
...
const (
	// Identifiers from group ofp_meter_feature_flags
	OFPMFFActionSet   = 1 // OFPMFF_ACTION_SET
	OFPMFFAnyPosition = 2 // OFPMFF_ANY_POSITION
	OFPMFFMultiList   = 4 // OFPMFF_MULTI_LIST
)

type MeterFeatureFlags uint32
...
const (
	...
	OFPXMCPacketRegs    = 32769 // OFPXMC_PACKET_REGS
...
const (
	// Identifiers from group ofp_oxs_class
	OFPXSCOpenflowBasic = 32770 // OFPXSC_OPENFLOW_BASIC
	OFPXSCExperimenter  = 65535 // OFPXSC_EXPERIMENTER
)
...
const (
	...
	OFPPUnset      = 4294967287 // OFPP_UNSET
...
const (
	// Identifiers from group ofp_port_desc_prop_type
	OFPPDPTEthernet       = 0     // OFPPDPT_ETHERNET
	OFPPDPTOptical        = 1     // OFPPDPT_OPTICAL
	OFPPDPTPipelineInput  = 2     // OFPPDPT_PIPELINE_INPUT
	OFPPDPTPipelineOutput = 3     // OFPPDPT_PIPELINE_OUTPUT
	OFPPDPTRecirculate    = 4     // OFPPDPT_RECIRCULATE
	OFPPDPTExperimenter   = 65535 // OFPPDPT_EXPERIMENTER
)
...
const (
	// Identifiers from group ofp_port_mod_prop_type
	OFPPMPTEthernet     = 0     // OFPPMPT_ETHERNET
	OFPPMPTOptical      = 1     // OFPPMPT_OPTICAL
	OFPPMPTExperimenter = 65535 // OFPPMPT_EXPERIMENTER
)
...
const (
	// Identifiers from group ofp_queue_desc_prop_type
	OFPQDPTMinRate      = 1     // OFPQDPT_MIN_RATE
	OFPQDPTMaxRate      = 2     // OFPQDPT_MAX_RATE
	OFPQDPTExperimenter = 65535 // OFPQDPT_EXPERIMENTER
)
...
const (
	// Identifiers from group ofp_queue_stats_prop_type
	OFPQSPTExperimenter = 65535 // OFPQSPT_EXPERIMENTER
)
...
const (
	// Identifiers from group ofp_role_prop_type
	OFPRPTExperimenter = 65535 // OFPRPT_EXPERIMENTER
)
...
const (
	// Identifiers from group ofp_stat_trigger_flags
	OFPSTFPeriodic  = 1 // OFPSTF_PERIODIC
	OFPSTFOnlyFirst = 2 // OFPSTF_ONLY_FIRST
)

type StatTriggerFlags uint32
...
const (
	...
	OFPMPFlowLightweight  = 17    // OFPMP_FLOW_LIGHTWEIGHT
	OFPMPControllerStatus = 18    // OFPMP_CONTROLLER_STATUS
	OFPMPBundleFeatures   = 19    // OFPMP_BUNDLE_FEATURES
...
const (
	...
	OFPRRFCIDUnsup  = 3 // OFPRRFC_ID_UNSUP
	OFPRRFCIDInUse  = 4 // OFPRRFC_ID_IN_USE
)
...
const (
	// Identifiers from group ofp_table_feature_flag
	OFPTFFIngressTable = 1  // OFPTFF_INGRESS_TABLE
	OFPTFFEgressTable  = 2  // OFPTFF_EGRESS_TABLE
	OFPTFFFirstEgress  = 16 // OFPTFF_FIRST_EGRESS
)

type TableFeatureFlag uint32
...
const (
	...
	OFPTFPTWriteCopyfield     = 18    // OFPTFPT_WRITE_COPYFIELD
	OFPTFPTWriteCopyfieldMiss = 19    // OFPTFPT_WRITE_COPYFIELD_MISS
	OFPTFPTApplyCopyfield     = 20    // OFPTFPT_APPLY_COPYFIELD
	OFPTFPTApplyCopyfieldMiss = 21    // OFPTFPT_APPLY_COPYFIELD_MISS
	OFPTFPTPacketTypes        = 22    // OFPTFPT_PACKET_TYPES
...
const (
	// Identifiers from group ofp_table_features_command
	OFPTFCReplace = 0 // OFPTFC_REPLACE
	OFPTFCModify  = 1 // OFPTFC_MODIFY
	OFPTFCEnable  = 2 // OFPTFC_ENABLE
	OFPTFCDisable = 3 // OFPTFC_DISABLE
)
...
const (
	...
	OFPTFFCBadCapa     = 6  // OFPTFFC_BAD_CAPA
	OFPTFFCBadMaxEnt   = 7  // OFPTFFC_BAD_MAX_ENT
	OFPTFFCBadFeatures = 8  // OFPTFFC_BAD_FEATURES
	OFPTFFCBadCommand  = 9  // OFPTFFC_BAD_COMMAND
	OFPTFFCTooMany     = 10 // OFPTFFC_TOO_MANY
)
...
const (
	// Identifiers from group ofp_table_mod_prop_type
	OFPTMPTEviction     = 2     // OFPTMPT_EVICTION
	OFPTMPTVacancy      = 3     // OFPTMPT_VACANCY
	OFPTMPTExperimenter = 65535 // OFPTMPT_EXPERIMENTER
)
...
const (
	...
	OFPTControllerStatus = 35 // OFPT_CONTROLLER_STATUS
)
