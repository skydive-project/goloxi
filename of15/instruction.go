...
func decodeInstruction(decoder *goloxi.Decoder) (IInstruction, error) {
	...
	case 7:
		return decodeInstructionStatTrigger(instruction, decoder)
	case 65535:
...
func decodeInstructionStatTrigger(parent *Instruction, decoder *goloxi.Decoder) (*InstructionStatTrigger, error) {
	instructionstattrigger := &InstructionStatTrigger{Instruction: parent}
	if decoder.Length() < 4 {
		return nil, fmt.Errorf("InstructionStatTrigger packet too short: %d < 4", decoder.Length())
	}
	instructionstattrigger.Flags = StatTriggerFlags(decoder.ReadUint32())
	...
	for decoder.Length() >= 4 {
		...
		instructionstattrigger.Thresholds = append(instructionstattrigger.Thresholds, item)
	}
	return instructionstattrigger, nil
}

func NewInstructionStatTrigger() *InstructionStatTrigger {
	return &InstructionStatTrigger{
