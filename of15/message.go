...
func (self *Header) Decode(decoder *goloxi.Decoder) error {
	...
	// if self.Version != 6 {
	// 	return fmt.Errorf("Wrong value '%d' for type, expected '6'.", self.Version)
	// }
...
func decodeHeader(decoder *goloxi.Decoder) (IHeader, error) {
	...
	// if header.Version != 6 {
	// 	return fmt.Errorf("Wrong value '%d' for type, expected '6'.", header.Version)
	// }
	...
	case 35:
		return decodeControllerStatus(header, decoder)
	default:
...
func decodeStatsReply(parent *Header, decoder *goloxi.Decoder) (IStatsReply, error) {
	...
	case 16:
		return decodeFlowMonitorReply(statsreply, decoder)
	case 17:
		return decodeFlowLightweightStatsReply(statsreply, decoder)
	case 18:
		return decodeControllerStatusStatsReply(statsreply, decoder)
	case 19:
		return decodeBundleFeaturesStatsReply(statsreply, decoder)
	case 65535:
...
func decodeAggregateStatsReply(parent *StatsReply, decoder *goloxi.Decoder) (*AggregateStatsReply, error) {
	...
	decoder.Skip(4)
	if err := aggregatestatsreply.Stats.Decode(decoder); err != nil {
		return nil, err
	}
...
func decodeStatsRequest(parent *Header, decoder *goloxi.Decoder) (IStatsRequest, error) {
	...
	case 16:
		return decodeFlowMonitorRequest(statsrequest, decoder)
	case 17:
		return decodeFlowLightweightStatsRequest(statsrequest, decoder)
	case 18:
		return decodeControllerStatusStatsRequest(statsrequest, decoder)
	case 19:
		return decodeBundleFeaturesStatsRequest(statsrequest, decoder)
	case 65535:
...
func decodeBundleAddMsg(parent *Header, decoder *goloxi.Decoder) (*BundleAddMsg, error) {
	...
	bundleaddmsg.Message.Decode(decoder)
	...
	for decoder.Length() >= 4 {
		...
		bundleaddmsg.Properties = append(bundleaddmsg.Properties, item)
	}
...
func decodeBundleFeaturesStatsReply(parent *StatsReply, decoder *goloxi.Decoder) (*BundleFeaturesStatsReply, error) {
	bundlefeaturesstatsreply := &BundleFeaturesStatsReply{StatsReply: parent}
	if decoder.Length() < 10 {
		return nil, fmt.Errorf("BundleFeaturesStatsReply packet too short: %d < 10", decoder.Length())
	}
	decoder.Skip(4)
	bundlefeaturesstatsreply.Capabilities = BundleFeatureFlags(decoder.ReadUint32())
	decoder.Skip(6)
	...
	for decoder.Length() >= 4 {
		...
		bundlefeaturesstatsreply.Properties = append(bundlefeaturesstatsreply.Properties, item)
	}
	return bundlefeaturesstatsreply, nil
}

func NewBundleFeaturesStatsReply() *BundleFeaturesStatsReply {
	return &BundleFeaturesStatsReply{
...
func decodeBundleFeaturesStatsRequest(parent *StatsRequest, decoder *goloxi.Decoder) (*BundleFeaturesStatsRequest, error) {
	bundlefeaturesstatsrequest := &BundleFeaturesStatsRequest{StatsRequest: parent}
	if decoder.Length() < 8 {
		return nil, fmt.Errorf("BundleFeaturesStatsRequest packet too short: %d < 8", decoder.Length())
	}
	decoder.Skip(4)
	bundlefeaturesstatsrequest.FeatureRequestFlags = BundleFeatureFlags(decoder.ReadUint32())
	decoder.Skip(4)
	...
	for decoder.Length() >= 4 {
		...
		bundlefeaturesstatsrequest.Properties = append(bundlefeaturesstatsrequest.Properties, item)
	}
	return bundlefeaturesstatsrequest, nil
}

func NewBundleFeaturesStatsRequest() *BundleFeaturesStatsRequest {
	return &BundleFeaturesStatsRequest{
...
func decodeControllerStatus(parent *Header, decoder *goloxi.Decoder) (*ControllerStatus, error) {
	controllerstatus := &ControllerStatus{Header: parent}
	if decoder.Length() < 16 {
		return nil, fmt.Errorf("ControllerStatus packet too short: %d < 16", decoder.Length())
	}
	controllerstatus.Entry.Decode(decoder)
...
func decodeControllerStatusStatsReply(parent *StatsReply, decoder *goloxi.Decoder) (*ControllerStatusStatsReply, error) {
	controllerstatusstatsreply := &ControllerStatusStatsReply{StatsReply: parent}
	decoder.Skip(4)
	...
	for decoder.Length() >= 16 {
		...
		controllerstatusstatsreply.ControllerStatus = append(controllerstatusstatsreply.ControllerStatus, item)
	}
	return controllerstatusstatsreply, nil
}

func NewControllerStatusStatsReply() *ControllerStatusStatsReply {
	return &ControllerStatusStatsReply{
...
func decodeFlowMod(parent *Header, decoder *goloxi.Decoder) (IFlowMod, error) {
	...
	flowmod.Importance = uint16(decoder.ReadUint16())
...
func decodeFlowLightweightStatsReply(parent *StatsReply, decoder *goloxi.Decoder) (*FlowLightweightStatsReply, error) {
	flowlightweightstatsreply := &FlowLightweightStatsReply{StatsReply: parent}
	decoder.Skip(4)
	...
	for decoder.Length() >= 24 {
		...
		flowlightweightstatsreply.Entries = append(flowlightweightstatsreply.Entries, item)
	}
	return flowlightweightstatsreply, nil
}

func NewFlowLightweightStatsReply() *FlowLightweightStatsReply {
	return &FlowLightweightStatsReply{
...
func decodeFlowLightweightStatsRequest(parent *StatsRequest, decoder *goloxi.Decoder) (*FlowLightweightStatsRequest, error) {
	flowlightweightstatsrequest := &FlowLightweightStatsRequest{StatsRequest: parent}
	if decoder.Length() < 40 {
		return nil, fmt.Errorf("FlowLightweightStatsRequest packet too short: %d < 40", decoder.Length())
	}
	decoder.Skip(4)
	flowlightweightstatsrequest.TableId = uint8(decoder.ReadByte())
	decoder.Skip(3)
	flowlightweightstatsrequest.OutPort.Decode(decoder)
	flowlightweightstatsrequest.OutGroup = uint32(decoder.ReadUint32())
	decoder.Skip(4)
	flowlightweightstatsrequest.Cookie = uint64(decoder.ReadUint64())
	flowlightweightstatsrequest.CookieMask = uint64(decoder.ReadUint64())
	if err := flowlightweightstatsrequest.Match.Decode(decoder); err != nil {
		return nil, err
	}

	decoder.SkipAlign()
	return flowlightweightstatsrequest, nil
}

func NewFlowLightweightStatsRequest() *FlowLightweightStatsRequest {
	return &FlowLightweightStatsRequest{
...
func decodeFlowMonitorReply(parent *StatsReply, decoder *goloxi.Decoder) (*FlowMonitorReply, error) {
	flowmonitorreply := &FlowMonitorReply{StatsReply: parent}
	decoder.Skip(4)
	...
	for decoder.Length() >= 4 {
		...
		flowmonitorreply.Entries = append(flowmonitorreply.Entries, item)
	}
	return flowmonitorreply, nil
}

func NewFlowMonitorReply() *FlowMonitorReply {
	return &FlowMonitorReply{
...
func decodeFlowMonitorRequest(parent *StatsRequest, decoder *goloxi.Decoder) (*FlowMonitorRequest, error) {
	flowmonitorrequest := &FlowMonitorRequest{StatsRequest: parent}
	decoder.Skip(4)
	...
	for decoder.Length() >= 24 {
		...
		flowmonitorrequest.Entries = append(flowmonitorrequest.Entries, item)
	}
	return flowmonitorrequest, nil
}

func NewFlowMonitorRequest() *FlowMonitorRequest {
	return &FlowMonitorRequest{
...
func decodeFlowRemoved(parent *Header, decoder *goloxi.Decoder) (*FlowRemoved, error) {
	...
	decoder.SkipAlign()
	if err := flowremoved.Stats.Decode(decoder); err != nil {
		return nil, err
	}
...
func decodeGroupMod(parent *Header, decoder *goloxi.Decoder) (IGroupMod, error) {
	...
	groupmod.BucketArrayLen = uint16(decoder.ReadUint16())
	decoder.Skip(2)
	groupmod.CommandBucketId = GroupBucket(decoder.ReadUint32())
	...
	for decoder.Length() >= 4 {
		...
		groupmod.Properties = append(groupmod.Properties, item)
	}
	...
	case 3:
		return decodeGroupInsertBucket(groupmod, decoder)
	case 5:
		return decodeGroupRemoveBucket(groupmod, decoder)
	default:
...
func decodeGroupAdd(parent *GroupMod, decoder *goloxi.Decoder) (*GroupAdd, error) {
	...
	if decoder.Length() < 24 {
		return nil, fmt.Errorf("GroupAdd packet too short: %d < 24", decoder.Length())
	}
	decoder.Skip(1)
	decoder.Skip(2)
	return groupadd, nil
...
func decodeGroupDelete(parent *GroupMod, decoder *goloxi.Decoder) (*GroupDelete, error) {
	...
	if decoder.Length() < 24 {
		return nil, fmt.Errorf("GroupDelete packet too short: %d < 24", decoder.Length())
	}
	decoder.Skip(1)
	decoder.Skip(2)
...
func decodeGroupDescStatsRequest(parent *StatsRequest, decoder *goloxi.Decoder) (*GroupDescStatsRequest, error) {
	...
	decoder.Skip(4)
	groupdescstatsrequest.GroupId = uint32(decoder.ReadUint32())
	decoder.Skip(4)
...
func decodeGroupInsertBucket(parent *GroupMod, decoder *goloxi.Decoder) (*GroupInsertBucket, error) {
	groupinsertbucket := &GroupInsertBucket{GroupMod: parent}
	if decoder.Length() < 24 {
		return nil, fmt.Errorf("GroupInsertBucket packet too short: %d < 24", decoder.Length())
	}
	decoder.Skip(1)
	decoder.Skip(2)
	return groupinsertbucket, nil
}

func NewGroupInsertBucket() *GroupInsertBucket {
	return &GroupInsertBucket{
...
func decodeGroupModify(parent *GroupMod, decoder *goloxi.Decoder) (*GroupModify, error) {
	...
	if decoder.Length() < 24 {
		return nil, fmt.Errorf("GroupModify packet too short: %d < 24", decoder.Length())
	}
	decoder.Skip(1)
	decoder.Skip(2)
...
func decodeGroupRemoveBucket(parent *GroupMod, decoder *goloxi.Decoder) (*GroupRemoveBucket, error) {
	groupremovebucket := &GroupRemoveBucket{GroupMod: parent}
	if decoder.Length() < 24 {
		return nil, fmt.Errorf("GroupRemoveBucket packet too short: %d < 24", decoder.Length())
	}
	decoder.Skip(1)
	decoder.Skip(2)
	return groupremovebucket, nil
}

func NewGroupRemoveBucket() *GroupRemoveBucket {
	return &GroupRemoveBucket{
...
func decodePacketOut(parent *Header, decoder *goloxi.Decoder) (*PacketOut, error) {
	...
	decoder.Skip(2)
	if err := packetout.Match.Decode(decoder); err != nil {
		return nil, err
	}
...
func decodePortDescStatsRequest(parent *StatsRequest, decoder *goloxi.Decoder) (*PortDescStatsRequest, error) {
	...
	decoder.Skip(4)
	portdescstatsrequest.PortNo.Decode(decoder)
	decoder.Skip(4)
...
func decodeRequestforward(parent *Header, decoder *goloxi.Decoder) (*Requestforward, error) {
	...
	requestforward.Request.Decode(decoder)
...
func decodeRoleReply(parent *Header, decoder *goloxi.Decoder) (*RoleReply, error) {
	...
	rolereply.ShortId = uint16(decoder.ReadUint16())
	decoder.Skip(2)
...
func decodeRoleRequest(parent *Header, decoder *goloxi.Decoder) (*RoleRequest, error) {
	...
	rolerequest.ShortId = uint16(decoder.ReadUint16())
	decoder.Skip(2)
