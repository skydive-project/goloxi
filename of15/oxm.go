...
func decodeOxm(decoder *goloxi.Decoder) (IOxm, error) {
	...
	case 2147506440:
		return decodeOxmPacketTypeMasked(oxm, decoder)
	case 100732:
	...
	case 2147505412:
		return decodeOxmTcpFlagsMasked(oxm, decoder)
	case 87164:
	...
	case 2147505154:
		return decodeOxmTcpFlags(oxm, decoder)
	case 112764:
	...
	case 2147506180:
		return decodeOxmPacketType(oxm, decoder)
	case 87932:
	...
	case 210696:
		return decodeOxmBsnIfpClassIdMasked(oxm, decoder)
	case 115836:
	...
	case 2147504898:
		return decodeOxmPbbUcaMasked(oxm, decoder)
	case 89980:
	...
	case 2147505928:
		return decodeOxmActsetOutputMasked(oxm, decoder)
	case 2147490818:
	...
	case 210436:
		return decodeOxmBsnIfpClassId(oxm, decoder)
	case 207112:
	...
	case 2147504641:
		return decodeOxmPbbUca(oxm, decoder)
	case 2147490056:
	...
	case 2147505668:
		return decodeOxmActsetOutput(oxm, decoder)
	case 87420:
...
func decodeOxmActsetOutput(parent *Oxm, decoder *goloxi.Decoder) (*OxmActsetOutput, error) {
	oxmactsetoutput := &OxmActsetOutput{Oxm: parent}
	if decoder.Length() < 1 {
		return nil, fmt.Errorf("OxmActsetOutput packet too short: %d < 1", decoder.Length())
	}
	oxmactsetoutput.Value = uint8(decoder.ReadByte())
	return oxmactsetoutput, nil
}

func NewOxmActsetOutput() *OxmActsetOutput {
	return &OxmActsetOutput{
		Oxm: NewOxm(2147505668),
	}
}
func (self *OxmActsetOutput) GetValue() interface{} {
	return self.Value
}

func (self *OxmActsetOutput) GetName() string {
	return "oxm_actset_output"
}
...
func decodeOxmActsetOutputMasked(parent *Oxm, decoder *goloxi.Decoder) (*OxmActsetOutputMasked, error) {
	oxmactsetoutputmasked := &OxmActsetOutputMasked{Oxm: parent}
	if decoder.Length() < 8 {
		return nil, fmt.Errorf("OxmActsetOutputMasked packet too short: %d < 8", decoder.Length())
	}
	oxmactsetoutputmasked.Value.Decode(decoder)
	oxmactsetoutputmasked.ValueMask.Decode(decoder)
	return oxmactsetoutputmasked, nil
}

func NewOxmActsetOutputMasked() *OxmActsetOutputMasked {
	return &OxmActsetOutputMasked{
		Oxm: NewOxm(2147505928),
	}
}
func (self *OxmActsetOutputMasked) GetValue() interface{} {
	return self.Value
}

func (self *OxmActsetOutputMasked) GetName() string {
	return "oxm_actset_output_masked"
}
...
func decodeOxmBsnIfpClassId(parent *Oxm, decoder *goloxi.Decoder) (*OxmBsnIfpClassId, error) {
	oxmbsnifpclassid := &OxmBsnIfpClassId{Oxm: parent}
	if decoder.Length() < 4 {
		return nil, fmt.Errorf("OxmBsnIfpClassId packet too short: %d < 4", decoder.Length())
	}
	oxmbsnifpclassid.Value = uint32(decoder.ReadUint32())
	return oxmbsnifpclassid, nil
}

func NewOxmBsnIfpClassId() *OxmBsnIfpClassId {
	return &OxmBsnIfpClassId{
		Oxm: NewOxm(210436),
	}
}
func (self *OxmBsnIfpClassId) GetValue() interface{} {
	return self.Value
}

func (self *OxmBsnIfpClassId) GetName() string {
	return "oxm_bsn_ifp_class_id"
}
...
func decodeOxmBsnIfpClassIdMasked(parent *Oxm, decoder *goloxi.Decoder) (*OxmBsnIfpClassIdMasked, error) {
	oxmbsnifpclassidmasked := &OxmBsnIfpClassIdMasked{Oxm: parent}
	if decoder.Length() < 8 {
		return nil, fmt.Errorf("OxmBsnIfpClassIdMasked packet too short: %d < 8", decoder.Length())
	}
	oxmbsnifpclassidmasked.Value = uint32(decoder.ReadUint32())
	oxmbsnifpclassidmasked.ValueMask = uint32(decoder.ReadUint32())
	return oxmbsnifpclassidmasked, nil
}

func NewOxmBsnIfpClassIdMasked() *OxmBsnIfpClassIdMasked {
	return &OxmBsnIfpClassIdMasked{
		Oxm: NewOxm(210696),
	}
}
func (self *OxmBsnIfpClassIdMasked) GetValue() interface{} {
	return self.Value
}

func (self *OxmBsnIfpClassIdMasked) GetName() string {
	return "oxm_bsn_ifp_class_id_masked"
}
...
func decodeOxmPacketType(parent *Oxm, decoder *goloxi.Decoder) (*OxmPacketType, error) {
	oxmpackettype := &OxmPacketType{Oxm: parent}
	if decoder.Length() < 1 {
		return nil, fmt.Errorf("OxmPacketType packet too short: %d < 1", decoder.Length())
	}
	oxmpackettype.Value = uint8(decoder.ReadByte())
	return oxmpackettype, nil
}

func NewOxmPacketType() *OxmPacketType {
	return &OxmPacketType{
		Oxm: NewOxm(2147506180),
	}
}
func (self *OxmPacketType) GetValue() interface{} {
	return self.Value
}

func (self *OxmPacketType) GetName() string {
	return "oxm_packet_type"
}
...
func decodeOxmPacketTypeMasked(parent *Oxm, decoder *goloxi.Decoder) (*OxmPacketTypeMasked, error) {
	oxmpackettypemasked := &OxmPacketTypeMasked{Oxm: parent}
	if decoder.Length() < 2 {
		return nil, fmt.Errorf("OxmPacketTypeMasked packet too short: %d < 2", decoder.Length())
	}
	oxmpackettypemasked.Value = uint8(decoder.ReadByte())
	oxmpackettypemasked.ValueMask = uint8(decoder.ReadByte())
	return oxmpackettypemasked, nil
}

func NewOxmPacketTypeMasked() *OxmPacketTypeMasked {
	return &OxmPacketTypeMasked{
		Oxm: NewOxm(2147506440),
	}
}
func (self *OxmPacketTypeMasked) GetValue() interface{} {
	return self.Value
}

func (self *OxmPacketTypeMasked) GetName() string {
	return "oxm_packet_type_masked"
}
...
func decodeOxmPbbUca(parent *Oxm, decoder *goloxi.Decoder) (*OxmPbbUca, error) {
	oxmpbbuca := &OxmPbbUca{Oxm: parent}
	if decoder.Length() < 1 {
		return nil, fmt.Errorf("OxmPbbUca packet too short: %d < 1", decoder.Length())
	}
	oxmpbbuca.Value = uint8(decoder.ReadByte())
	return oxmpbbuca, nil
}
...
func (self *OxmPbbUca) GetValue() interface{} {
	return self.Value
}

func (self *OxmPbbUca) GetName() string {
	return "oxm_pbb_uca"
}
...
func decodeOxmPbbUcaMasked(parent *Oxm, decoder *goloxi.Decoder) (*OxmPbbUcaMasked, error) {
	oxmpbbucamasked := &OxmPbbUcaMasked{Oxm: parent}
	if decoder.Length() < 2 {
		return nil, fmt.Errorf("OxmPbbUcaMasked packet too short: %d < 2", decoder.Length())
	}
	oxmpbbucamasked.Value = uint8(decoder.ReadByte())
	oxmpbbucamasked.ValueMask = uint8(decoder.ReadByte())
	return oxmpbbucamasked, nil
}

func NewOxmPbbUcaMasked() *OxmPbbUcaMasked {
	return &OxmPbbUcaMasked{
		Oxm: NewOxm(2147504898),
	}
}
func (self *OxmPbbUcaMasked) GetValue() interface{} {
	return self.Value
}

func (self *OxmPbbUcaMasked) GetName() string {
	return "oxm_pbb_uca_masked"
}
...
func decodeOxmTcpFlags(parent *Oxm, decoder *goloxi.Decoder) (*OxmTcpFlags, error) {
	oxmtcpflags := &OxmTcpFlags{Oxm: parent}
	if decoder.Length() < 1 {
		return nil, fmt.Errorf("OxmTcpFlags packet too short: %d < 1", decoder.Length())
	}
	oxmtcpflags.Value = uint8(decoder.ReadByte())
	return oxmtcpflags, nil
}
...
func (self *OxmTcpFlags) GetValue() interface{} {
	return self.Value
}

func (self *OxmTcpFlags) GetName() string {
	return "oxm_tcp_flags"
}
...
func decodeOxmTcpFlagsMasked(parent *Oxm, decoder *goloxi.Decoder) (*OxmTcpFlagsMasked, error) {
	oxmtcpflagsmasked := &OxmTcpFlagsMasked{Oxm: parent}
	if decoder.Length() < 2 {
		return nil, fmt.Errorf("OxmTcpFlagsMasked packet too short: %d < 2", decoder.Length())
	}
	oxmtcpflagsmasked.Value = uint8(decoder.ReadByte())
	oxmtcpflagsmasked.ValueMask = uint8(decoder.ReadByte())
	return oxmtcpflagsmasked, nil
}

func NewOxmTcpFlagsMasked() *OxmTcpFlagsMasked {
	return &OxmTcpFlagsMasked{
		Oxm: NewOxm(2147505412),
	}
}
func (self *OxmTcpFlagsMasked) GetValue() interface{} {
	return self.Value
}

func (self *OxmTcpFlagsMasked) GetName() string {
	return "oxm_tcp_flags_masked"
}
